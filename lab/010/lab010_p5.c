//  Create a structure to specify data of customers in a bank. The data to be stores is : Account
...
// Account number, code ( 1 for deposit, 0 for withdrawal)
// Write a program to five a message “ the balance is insufficient for the specified withdrawal”,
// if on withdrawal the balance falls below Rs1000.
